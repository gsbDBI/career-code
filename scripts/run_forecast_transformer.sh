...
NAME=forecast_final_one_job_year_with_unemployment_two_stage_learned_year_embeds_all_covs_except_gender_and_ethnicity_fp16_12_layers_192_embed_768_ffn_3_heads
