...
TRAIN_SIZE=10000000
NAME=occ1990dd_for_transformer_downsampled_${TRAIN_SIZE}
python ~/FOW_2.0/src/fairseq/train.py --task labor_modeling \
  /oak/stanford/groups/athey/laborai/Zippia/fairseq_data_bin/downsampled_resumes_occ1990dd_${TRAIN_SIZE} \
  ...
  --tensorboard-logdir ~/FOW_2.0/src/fairseq/zippia-downsample-logs/$NAME \
