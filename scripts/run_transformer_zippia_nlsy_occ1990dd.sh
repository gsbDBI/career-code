...
# NAME=occ1990dd_for_nlsy_transformer_final_one_job_year_year_eth_gender_embeds
# python ~/FOW_2.0/src/fairseq/train.py --task labor_modeling \
#   /oak/stanford/groups/athey/laborai/Zippia/fairseq_data_bin/zippia_final_one_job_year_with_unemployment_nilf_student_no_skipped_jobs_occ1990dd_nlsy \
