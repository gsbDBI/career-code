...
NAME=final_one_job_year_with_unemployment_two_stage_year_state_edu_embeds_fp16_12_layers_192_embed_768_ffn_3_heads
# NAME=final_one_job_year_with_unemployment_two_stage_year_state_edu_embeds_fp16_gpt
python ~/FOW_2.0/src/fairseq/train.py --task labor_modeling \
  ...
  --two-stage --year-embeddings \
  --state-embeddings --education-embeddings \
  --fp16 \
  --decoder-layers 12 --decoder-embed-dim 192 \
