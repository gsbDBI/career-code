...
# ZIPPIA_DIR=/oak/stanford/groups/athey/laborai/Zippia/fairseq_input_final_one_job_year_with_unemployment_nilf_student_no_skipped_jobs_occ1990dd_nlsy
# FAIRSEQ_DIR=/oak/stanford/groups/athey/laborai/Zippia/fairseq_data_bin/zippia_final_one_job_year_with_unemployment_nilf_student_no_skipped_jobs_occ1990dd_nlsy
