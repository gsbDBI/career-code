...
ZIPPIA_DIR=/oak/stanford/groups/athey/laborai/Zippia/fairseq_input_forecast_one_job_year_without_unemployment_nilf_student_no_skipped_jobs_occ1990dd
FAIRSEQ_DIR=/oak/stanford/groups/athey/laborai/Zippia/fairseq_data_bin/zippia_forecast_one_job_year_without_unemployment_nilf_student_no_skipped_jobs_occ1990dd
