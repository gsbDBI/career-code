...
ZIPPIA_DIR=/oak/stanford/groups/athey/laborai/Zippia/fairseq_input_forecast_one_job_year_with_unemployment_nilf_student_no_skipped_jobs_occ1990dd_2009_cutoff
FAIRSEQ_DIR=/oak/stanford/groups/athey/laborai/Zippia/fairseq_data_bin/zippia_forecast_one_job_year_with_unemployment_nilf_student_no_skipped_jobs_occ1990dd_2009_cutoff

## Create dictionary for year, and then order it
fairseq-preprocess \
    --only-source \
    --trainpref $ZIPPIA_DIR/all.year \
...
## Create dictionary for tok and ethnicity, because PSID/NLSY have some extra
## tokens.
