...
NAME=bag_of_jobs_final_one_job_year_with_unemployment_with_covs_no_gender_or_ethnicity_1024_dim_two_stage_no_fp16
python ~/FOW_2.0/src/fairseq/train.py --task labor_modeling \
 /oak/stanford/groups/athey/laborai/Zippia/fairseq_data_bin/zippia_final_one_job_year_with_unemployment \
  ...
  --two-stage \
  --include-year --include-education --include-state 