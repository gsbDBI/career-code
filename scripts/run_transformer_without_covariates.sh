...
NAME=final_one_job_year_with_unemployment_two_stage_no_embeds_fp16_12_layers_192_embed_768_ffn_3_heads
# NAME=final_one_job_year_with_unemployment_two_stage_no_embeds_fp16_gpt
