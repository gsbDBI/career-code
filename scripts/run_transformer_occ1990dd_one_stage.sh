...
NAME=occ1990dd_for_transformer_unified_one_job_year_without_unemployment_all_embeds_fp16_12_layers_192_embed_768_ffn_3_heads_skip_gender_and_ethnicity_one_stage
python ~/FOW_2.0/src/fairseq/train.py --task labor_modeling \
  ...
  --year-embeddings --ethnicity-embeddings \
